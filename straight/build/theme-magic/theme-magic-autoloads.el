;;; theme-magic-autoloads.el --- automatically extracted autoloads (do not edit)   -*- lexical-binding: t -*-
...
method chooses colors for the Linux theme." t)
...
`Theme-Magic-Export-Theme mode' mode.  If the prefix argument is
...
evaluate `(default-value \\='theme-magic-export-theme-mode)'.

The mode's hook is called both when the mode is enabled and when
it is disabled.

(fn &optional ARG)" t)
(register-definition-prefixes "theme-magic" '("theme-magic-"))

;;; End of scraped data

(provide 'theme-magic-autoloads)
